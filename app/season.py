...
VTB_COMP_ID = 55613       # Регулярный чемпионат ВТБ 2026/27 (таблица, команды, статистика)
VTB_SEASON_ID = 55613     # календарь сезона 2026/27 (пока расписание не залито —
                          # тот же номер; если календарь окажется под другим,
                          # поправить это число)
VTB_LABEL = "2026/27"
